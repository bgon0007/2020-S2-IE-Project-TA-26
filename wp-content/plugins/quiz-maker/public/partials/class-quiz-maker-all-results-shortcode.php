...
class Quiz_Maker_All_Results
{
    ...
    public function enqueue_styles(){
        wp_enqueue_style($this->plugin_name.'-dataTable', '//cdn.datatables.net/1.10.21/css/jquery.dataTables.min.css', array(),$this->version, 'all');
    }

    public function enqueue_scripts() {
        wp_enqueue_script($this->plugin_name.'-dataTable', '//cdn.datatables.net/1.10.21/js/jquery.dataTables.min.js', array('jquery'), $this->version, true);
